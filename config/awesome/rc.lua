...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, }, "p", function () awful.util.spawn("dmenu_run -nb '#000' -nf '#fff' -sb '#333' -sf '#fff'") end),
    ...
    awful.key({ modkey, }, ".", function () awful.util.spawn("amixer -q -c 0 sset Master 5%+ unmute") end),
    awful.key({ modkey, }, ",", function () awful.util.spawn("amixer -q -c 0 sset Master 5%- unmute") end),
    ...
    awful.key({ "Mod1" }, "Print",
        function ()
awful.util.spawn("scrot -u -e 'mv $f ~/imgs/scrot/'")
os.execute("sleep 0.5")
naughty.notify({ title="scrot", text="The focused window captured" })
        end),
    awful.key({}, "Print",
        function ()
awful.util.spawn("scrot -e 'mv $f ~/imgs/scrot/'")
os.execute("sleep 0.5")
naughty.notify({ title="scrot", text="Full screen captured" })
        end),
...
awful.rules.rules = {
    ...
    { rule = { class = "Gimp" }, properties = { floating = true, tag = tags[1][6] } },
    ...
    { rule = { class = "Pidgin" }, properties = { floating = true, tag = tags[1][8] } },
	 ...
	 --{ rule = { class = "Terminator" },  properties = {floating = true}},
}
-- }}}
